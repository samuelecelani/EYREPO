...
--
-- Name: anagrafica anagrafica_idsezione1_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY piao_private.anagrafica
    ADD CONSTRAINT anagrafica_idsezione1_key UNIQUE (idsezione1);
...
--
-- Name: anagrafica fk_anagrafica_sezione1; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY piao_private.anagrafica
    ADD CONSTRAINT fk_anagrafica_sezione1 FOREIGN KEY (idsezione1) REFERENCES piao_private.sezione1(id) ON DELETE CASCADE;
...
INSERT INTO piao_private.configurazioni (codice,valore,typedato,isconfigui,x_validity_in,x_createdby,x_created_ts,x_updatedby,x_updated_ts,x_createdbyrole,x_updatedbyrole,x_createdbynamesurname,x_updatedbynamesurname,x_active,x_deactivationtime) VALUES
	 ('BODY_EMAIL_DEFAULT','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_332_RIFIUTA_VALIDAZIONE','Rifiutata la richiesta di validazione Sezione 3.3.2','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_332_RICHIEDI_VALIDAZIONE','Richiesta la validazione  Sezione 3.3.2','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('DataInizio','2022','Date',false,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_332_REVOCA_VALIDAZIONE','Revocata la richiesta di validazione Sezione 3.3.2','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_332_ANNULLA_VALIDAZIONE','Annullata la richiesta di validazione Sezione 3.3.2','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('DataFine','2032','Date',false,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('FROM_ADDRESS','collaudo@performance.gov.it','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('FROM_ADDRESS_NAME','Sistema PIAO','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('NOTIFICA_GENERA_PDF','Testo di una notifica genera pdf','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL);
INSERT INTO piao_private.configurazioni (codice,valore,typedato,isconfigui,x_validity_in,x_createdby,x_created_ts,x_updatedby,x_updated_ts,x_createdbyrole,x_updatedbyrole,x_createdbynamesurname,x_updatedbynamesurname,x_active,x_deactivationtime) VALUES
	 ('NOTIFICA_GENERA_EXCEL','Testo di una notifica genera excel','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_1_RICHIEDI_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_1_REVOCA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_1_ANNULLA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_1_ACCETTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_1_RIFIUTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_21_RICHIEDI_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_21_REVOCA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_21_ANNULLA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_21_ACCETTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL);
INSERT INTO piao_private.configurazioni (codice,valore,typedato,isconfigui,x_validity_in,x_createdby,x_created_ts,x_updatedby,x_updated_ts,x_createdbyrole,x_updatedbyrole,x_createdbynamesurname,x_updatedbynamesurname,x_active,x_deactivationtime) VALUES
	 ('BODY_EMAIL_SEZIONE_21_RIFIUTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_22_RICHIEDI_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_22_REVOCA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_22_ANNULLA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_22_ACCETTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_22_RIFIUTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_23_RICHIEDI_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_23_REVOCA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_23_ANNULLA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_23_ACCETTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL);
INSERT INTO piao_private.configurazioni (codice,valore,typedato,isconfigui,x_validity_in,x_createdby,x_created_ts,x_updatedby,x_updated_ts,x_createdbyrole,x_updatedbyrole,x_createdbynamesurname,x_updatedbynamesurname,x_active,x_deactivationtime) VALUES
	 ('BODY_EMAIL_SEZIONE_23_RIFIUTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_31_RICHIEDI_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_31_REVOCA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_31_ANNULLA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_31_ACCETTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_31_RIFIUTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_32_RICHIEDI_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_32_REVOCA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_32_ANNULLA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_332_ACCETTA_VALIDAZIONE','Accettata la richiesta di validazione Sezione 3.3.2','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL);
INSERT INTO piao_private.configurazioni (codice,valore,typedato,isconfigui,x_validity_in,x_createdby,x_created_ts,x_updatedby,x_updated_ts,x_createdbyrole,x_updatedbyrole,x_createdbynamesurname,x_updatedbynamesurname,x_active,x_deactivationtime) VALUES
	 ('BODY_EMAIL_SEZIONE_4_RICHIEDI_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_4_REVOCA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_4_ANNULLA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_4_ACCETTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_32_ACCETTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_32_RIFIUTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_331_RICHIEDI_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_331_REVOCA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_331_ANNULLA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_331_ACCETTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL);
INSERT INTO piao_private.configurazioni (codice,valore,typedato,isconfigui,x_validity_in,x_createdby,x_created_ts,x_updatedby,x_updated_ts,x_createdbyrole,x_updatedbyrole,x_createdbynamesurname,x_updatedbynamesurname,x_active,x_deactivationtime) VALUES
	 ('BODY_EMAIL_SEZIONE_331_RIFIUTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_332_RICHIEDI_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_332_REVOCA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_332_ANNULLA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_332_ACCETTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_332_RIFIUTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_21_RIFIUTA_VALIDAZIONE','Rifiutata la richiesta di validazione Sezione 2.1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_21_RICHIEDI_VALIDAZIONE','Richiesta la validazione  Sezione 2.1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_21_REVOCA_VALIDAZIONE','Revocata la richiesta di validazione Sezione 2.1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_21_ACCETTA_VALIDAZIONE','Accettata la richiesta di validazione Sezione 2.1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL);
INSERT INTO piao_private.configurazioni (codice,valore,typedato,isconfigui,x_validity_in,x_createdby,x_created_ts,x_updatedby,x_updated_ts,x_createdbyrole,x_updatedbyrole,x_createdbynamesurname,x_updatedbynamesurname,x_active,x_deactivationtime) VALUES
	 ('MAIL_OBJECT_SEZIONE_1_RIFIUTA_VALIDAZIONE','Rifiutata la richiesta di validazione Sezione 1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_1_RICHIEDI_VALIDAZIONE','Richiesta la validazione  Sezione 1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_1_REVOCA_VALIDAZIONE','Revocata la richiesta di validazione Sezione 1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_1_ACCETTA_VALIDAZIONE','Accettata la richiesta di validazione Sezione 1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_22_RIFIUTA_VALIDAZIONE','Rifiutata la richiesta di validazione Sezione 2.2','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_22_RICHIEDI_VALIDAZIONE','Richiesta la validazione  Sezione 2.2','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_22_REVOCA_VALIDAZIONE','Revocata la richiesta di validazione Sezione 2.2','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_22_ACCETTA_VALIDAZIONE','Accettata la richiesta di validazione Sezione 2.2','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_23_RIFIUTA_VALIDAZIONE','Rifiutata la richiesta di validazione Sezione 2.3','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_23_RICHIEDI_VALIDAZIONE','Richiesta la validazione  Sezione 2.3','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL);
INSERT INTO piao_private.configurazioni (codice,valore,typedato,isconfigui,x_validity_in,x_createdby,x_created_ts,x_updatedby,x_updated_ts,x_createdbyrole,x_updatedbyrole,x_createdbynamesurname,x_updatedbynamesurname,x_active,x_deactivationtime) VALUES
	 ('MAIL_OBJECT_SEZIONE_23_REVOCA_VALIDAZIONE','Revocata la richiesta di validazione Sezione 2.3','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_23_ACCETTA_VALIDAZIONE','Accettata la richiesta di validazione Sezione 2.3','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_23_ANNULLA_VALIDAZIONE','Annullata la richiesta di validazione Sezione 2.3','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_1_ANNULLA_VALIDAZIONE','Annullata la richiesta di validazione Sezione 1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_21_ANNULLA_VALIDAZIONE','Annullata la richiesta di validazione Sezione 2.1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_22_ANNULLA_VALIDAZIONE','Annullata la richiesta di validazione Sezione 2.2','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_31_RIFIUTA_VALIDAZIONE','Rifiutata la richiesta di validazione Sezione 3.1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_31_RICHIEDI_VALIDAZIONE','Richiesta la validazione  Sezione 3.1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_31_REVOCA_VALIDAZIONE','Revocata la richiesta di validazione Sezione 3.1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_31_ANNULLA_VALIDAZIONE','Annullata la richiesta di validazione Sezione 3.1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL);
INSERT INTO piao_private.configurazioni (codice,valore,typedato,isconfigui,x_validity_in,x_createdby,x_created_ts,x_updatedby,x_updated_ts,x_createdbyrole,x_updatedbyrole,x_createdbynamesurname,x_updatedbynamesurname,x_active,x_deactivationtime) VALUES
	 ('MAIL_OBJECT_SEZIONE_31_ACCETTA_VALIDAZIONE','Accettata la richiesta di validazione Sezione 3.1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_32_RIFIUTA_VALIDAZIONE','Rifiutata la richiesta di validazione Sezione 3.2','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_32_RICHIEDI_VALIDAZIONE','Richiesta la validazione  Sezione 3.2','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_32_REVOCA_VALIDAZIONE','Revocata la richiesta di validazione Sezione 3.2','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_32_ANNULLA_VALIDAZIONE','Annullata la richiesta di validazione Sezione 3.2','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_32_ACCETTA_VALIDAZIONE','Accettata la richiesta di validazione Sezione 3.2','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_331_RIFIUTA_VALIDAZIONE','Rifiutata la richiesta di validazione Sezione 3.3.1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_331_RICHIEDI_VALIDAZIONE','Richiesta la validazione  Sezione 3.3.1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_331_REVOCA_VALIDAZIONE','Revocata la richiesta di validazione Sezione 3.3.1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_331_ANNULLA_VALIDAZIONE','Annullata la richiesta di validazione Sezione 3.3.1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL);
INSERT INTO piao_private.configurazioni (codice,valore,typedato,isconfigui,x_validity_in,x_createdby,x_created_ts,x_updatedby,x_updated_ts,x_createdbyrole,x_updatedbyrole,x_createdbynamesurname,x_updatedbynamesurname,x_active,x_deactivationtime) VALUES
	 ('MAIL_OBJECT_SEZIONE_331_ACCETTA_VALIDAZIONE','Accettata la richiesta di validazione Sezione 3.3.1','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_SEZIONE_4_RIFIUTA_VALIDAZIONE','<h1>Email di test</h1><p>Questa è un''email di prova inviata dal sistema PIAO.</p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_4_RIFIUTA_VALIDAZIONE','Rifiutata la richiesta di validazione Sezione 4','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_4_RICHIEDI_VALIDAZIONE','Richiesta la validazione  Sezione 4','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_4_REVOCA_VALIDAZIONE','Revocata la richiesta di validazione Sezione 4','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_4_ANNULLA_VALIDAZIONE','Annullata la richiesta di validazione Sezione 4','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_SEZIONE_4_ACCETTA_VALIDAZIONE','Accettata la richiesta di validazione Sezione 4','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('MAIL_OBJECT_APPROVA_PIAO','Richiesta di approvazione Piao','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('BODY_EMAIL_APPROVA_PIAO','<h1>Richiesta di Approvazione PIAO</h1>
...
<p><a href="{{URL_APPROVAZIONE}}">Clicca qui per visualizzare e approvare il PIAO</a></p>','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL),
	 ('URL_APPROVAZIONE_PIAO','http://localhost:4200/page/pubblicato','String',true,true,'ADMIN','2026-04-16',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL);
INSERT INTO piao_private.configurazioni (codice,valore,typedato,isconfigui,x_validity_in,x_createdby,x_created_ts,x_updatedby,x_updated_ts,x_createdbyrole,x_updatedbyrole,x_createdbynamesurname,x_updatedbynamesurname,x_active,x_deactivationtime) VALUES
	 ('TEMPLATE_EMAIL_SOLLECITI','<p>Testo Sollecito</p>','String',false,true,'ADMIN','2026-05-13',NULL,NULL,NULL,NULL,NULL,NULL,true,NULL);
