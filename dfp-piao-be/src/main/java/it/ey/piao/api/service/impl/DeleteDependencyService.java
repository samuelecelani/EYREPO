...
public class DeleteDependencyService {
    ...
    public void cambiaStatoSezioneInCompilazione(Long idPiao, Sezione sezione, String reason, BaseDTO dto) {
        ...
        // CAMBIO STATO DELLA SEZIONE + recupero dell'ID reale della sezione
        Long idSezione;
        switch (sezione) {
            case SEZIONE_21 -> idSezione = cambiaSezione21(idPiao, reason, dto);
            case SEZIONE_22 -> idSezione = cambiaSezione22(idPiao, reason, dto);
            case SEZIONE_23 -> idSezione = cambiaSezione23(idPiao, reason, dto);
            case SEZIONE_31 -> idSezione = cambiaSezione31(idPiao, reason, dto);
            case SEZIONE_32 -> idSezione = cambiaSezione32(idPiao, reason, dto);
            case SEZIONE_331 -> idSezione = cambiaSezione331(idPiao, reason, dto);
            case SEZIONE_332 -> idSezione = cambiaSezione332(idPiao, reason, dto);
            default -> {
        ...
        if (idSezione == null) {
            log.warn("idSezione nullo per Piao id={} sezione={}: storico stato non salvato", idPiao, sezione);
            return;
        }

        salvaStoricoStato(idSezione, sezione, reason);
    }
    ...
    private Long cambiaSezione21(Long idPiao, String reason, BaseDTO dto) {
        if (idPiao == null) {
            return null;
        }
        ...
        return sezione21.getId();
    }

    private Long cambiaSezione22(Long idPiao, String reason, BaseDTO dto) {
        if (idPiao == null) {
            return null;
        }
        ...
        return sezione22.getId();
    }


    private Long cambiaSezione23(Long idPiao, String reason, BaseDTO dto) {
        if (idPiao == null) {
            return null;
        }
        ...
        return sezione23.getId();
    }

    private Long cambiaSezione31(Long idPiao, String reason, BaseDTO dto) {
        if (idPiao == null) {
            return null;
        }
        ...
        return sezione31.getId();
    }

    private Long cambiaSezione32(Long idPiao, String reason, BaseDTO dto) {
        if (idPiao == null) {
            return null;
        }
        ...
        return sezione32.getId();
    }

    private Long cambiaSezione331(Long idPiao, String reason, BaseDTO dto) {
        if (idPiao == null) {
            return null;
        }
        ...
        return sezione331.getId();
    }

    private Long cambiaSezione332(Long idPiao, String reason, BaseDTO dto) {
        if (idPiao == null) {
            return null;
        }
