...
@Mapper(
    ...
    uses ={ CommonMapper.class, PrioritaPoliticaMapper.class, AreaOrganizzativaMapper.class,SezioneBaseMapper.class}
...
public interface Sezione1Mapper {
    ...
    @Mapping(target = "anagrafica", ignore = true) // MongoDB - gestito separatamente
    ...
    @Mapping(target = "anagrafica", ignore = true)// Gestito manualmente
