...
public interface IAttoreRepository extends BaseMongoRepository<Attore, String> {
    ...
    Attore findByExternalIdFKAndTipoSezione(Long externalIdFK, Sezione sezione);
    Attore findByExternalIdAndExternalIdFKAndTipoSezione(Long externalId, Long externalIdFK, Sezione sezione);
}
