...
public class EventoRischioServiceImpl implements IEventoRischioService {
    ...
    public EventoRischioServiceImpl(IEventoRischioRepository eventoRischioRepository,
                                    ...
                                    ILivelloRischioRepository livelloRischioRepository,
                                    IFattoreRepository fattoreRepository,
                                    ApplicationEventPublisher eventPublisher,
                                    StoricoModificaHelper storicoModificaHelper, ISezione23Repository sezione23Repository, IStoricoStatoSezioneRepository storicoStatoSezioneRepository, IMisuraPrevenzioneEventoRischioService misuraPrevenzioneEventoRischioService, IMisuraPrevenzioneEventoRischioRepository misuraPrevenzioneEventoRischioRepository, IMisuraPrevenzioneEventoRischioRepository misuraPrevenzioneEventoRischioRepository1, IMisuraPrevenzioneEventoRischioService misuraPrevenzioneEventoRischioService1) {
        ...
        this.misuraPrevenzioneEventoRischioService = misuraPrevenzioneEventoRischioService1;
    }
    ...
    public EventoRischioDTO saveOrUpdate(EventoRischioDTO dto) {
        ...
        try {
            ...
            storicoModificaHelper.salvaStoricoSePresente(dto, dto.getIdSezione23(), dto.getIdPiao(), Sezione.SEZIONE_23);

            if (dto.getStatoSezione() != null && !dto.getStatoSezione().isBlank() && !StatoEnum.fromDescrizione(dto.getStatoSezione()).name().equals(StoricoStatoSezioneUtils.getStato(storicoStatoSezioneRepository.findByIdEntitaAndCodTipologia(savedEntity.getSezione23().getId(),Sezione.SEZIONE_23.name())))) {
    ...
    public List<EventoRischioDTO> getAllByAttivitaSensibile(Long idAttivitaSensibile) {
        ...
        try {
            ...
            List<EventoRischio> entities = eventoRischioRepository.findByAttivitaSensibileId(attivitaSensibile.getId());
    ...
    public void deleteById(Long id, String campiModificati, Long idPiao, String testoSezione, String updatedByNameSurname, String updatedByRole, String statoSezione) {
        ...
        try {
            ...
            softDeleteMisureByEventoRischioId(id, campiModificati, idPiao, testoSezione, updatedByNameSurname, updatedByRole, statoSezione);

            // Cancellazione da Postgres
            eventoRischioRepository.softDeleteById(id, LocalDateTime.now());
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    public void deleteByAttivitaSensibile(Long idAttivitaSensibile, String campiModificati, Long idPiao, String testoSezione, String updatedByNameSurname, String updatedByRole, String statoSezione) {
        if (idAttivitaSensibile == null) {
            throw new IllegalArgumentException("L'ID dell'AttivitaSensibile non può essere nullo");
        }
        ...
        try {
            ...
            for (EventoRischio eventoRischio : eventiRischio) {
                ...
                //  soft delete delle misure collegate (che a sua volta spegne join indicatori/stakeholder)
                List<Long> misuraIds = misuraPrevenzioneEventoRischioRepository
                    .findActiveIdsByEventoRischioId(eventoRischio.getId());
            ...
            // Cancellazione da Postgres
            eventoRischioRepository.deleteByAttivitaSensibileId(idAttivitaSensibile, LocalDateTime.now());
            ...
            if (campiModificati != null && !campiModificati.isBlank() && idPiao != null) {
                BaseDTO dto = BaseDTO.builder()
                    ...
                    .statoSezione(statoSezione)
                    .build();
                storicoModificaHelper.salvaStoricoSePresente(dto, eventiRischio.get(0).getSezione23().getId(), idPiao, Sezione.SEZIONE_23);
            }

            // Salva storico stato sezione dopo la cancellazione
            if (statoSezione != null && !statoSezione.isBlank() && !eventiRischio.isEmpty()) {
                if (!StatoEnum.fromDescrizione(statoSezione).name().equals(StoricoStatoSezioneUtils.getStato(storicoStatoSezioneRepository.findByIdEntitaAndCodTipologia(eventiRischio.get(0).getSezione23().getId(), Sezione.SEZIONE_23.name())))) {
                    storicoStatoSezioneRepository.save(
                        StoricoStatoSezione.builder().statoSezione(
                                StatoSezione.builder()
                                    .id(StatoEnum.fromDescrizione(statoSezione).getId())
                                    .testo(StatoEnum.fromDescrizione(statoSezione).getDescrizione())
                                    .build())
                            .idEntitaFK(eventiRischio.get(0).getSezione23().getId())
                            .codTipologiaFK(Sezione.SEZIONE_23.name())
                            .testo(StatoEnum.fromDescrizione(statoSezione).getDescrizione())
                            .createdByNameSurname(updatedByNameSurname)
                            .createdByRole(updatedByRole)
    ...
    private void softDeleteMisureByEventoRischioId(Long idEventoRischio,
        ...
        List<Long> misuraIds = misuraPrevenzioneEventoRischioRepository.findActiveIdsByEventoRischioId(idEventoRischio);
    ...
    public void saveMongoData(EventoRischioDTO request) {
        ...
        try {
            ...
            UlterioriInfo ultInfoEntity = request.getUlterioriInfo() != null
                ...
                : null;
            if (ultInfoEntity != null) ultInfoEntity.setExternalId(request.getId());
            mongoUtils.saveItem(ultInfoEntity, request.getId(),
                ulterioriInfoRepository, UlterioriInfo.class,
                en -> en.setTipoSezione(Sezione.SEZIONE_23_EVENTORISCHIO),
                "tipoSezione", Sezione.SEZIONE_23_EVENTORISCHIO);

            // Salva Fattore in MongoDB
            Fattore fattoreEntity = request.getFattore() != null
                ? eventoRischioMapper.fattoreToEntity(request.getFattore(), context)
                : null;
            if (fattoreEntity != null) fattoreEntity.setExternalId(request.getId());
            mongoUtils.saveItem(fattoreEntity, request.getId(),
                fattoreRepository, Fattore.class,
                en -> en.setTipoSezione(Sezione.SEZIONE_23_EVENTORISCHIO),
                "tipoSezione", Sezione.SEZIONE_23_EVENTORISCHIO);
