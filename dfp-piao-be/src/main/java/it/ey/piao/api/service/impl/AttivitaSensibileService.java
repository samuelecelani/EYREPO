...
public class AttivitaSensibileService implements IAttivitaSensibileService {
    ...
    public AttivitaSensibileService(IAttivitaSensibileRepository attivitaSensibileRepository,
                                    ...
                                    IMisuraPrevenzioneEventoRischioService misuraPrevenzioneEventoRischioService,
                                    StoricoModificaHelper storicoModificaHelper, IStoricoStatoSezioneRepository storicoStatoSezioneRepository, IEventoRischioRepository eventoRischioRepository) {
    ...
    public void saveOrUpdate(AttivitaSensibileDTO dto) {
        ...
        try {
            ...
            if (dto.getCampiModificati() != null && !dto.getCampiModificati().isBlank() && dto.getIdPiao() != null ) {
                storicoModificaHelper.salvaStoricoSePresente(dto, savedEntity.getSezione23().getId(), dto.getIdPiao(), Sezione.SEZIONE_23);
            }
    ...
    public List<AttivitaSensibileDTO> getAllBySezione23(Long idSezione23) {
        ...
        try {
            ...
            List<AttivitaSensibile> entities = attivitaSensibileRepository.getAttivitaSensibileByIdSezione23(sezione23.getId());
    ...
    public void deleteById(Long id, String campiModificati, Long idPiao, String testoSezione, String updatedByNameSurname, String updatedByRole, String statoSezione) {
        ...
        try {
            ...
            // SOFT DELETE relazione con Evento Rischio
            eventoRischioRepository.softDeleteByAttivitaSensibileId(id,deactivationTime);

            // Cancellazione da Postgres
            attivitaSensibileRepository.softDeleteById(id, deactivationTime);
    ...
    public void saveMongoData(AttivitaSensibileDTO request) {
        ...
        try {
            ...
            mongoUtils.saveItem(ultInfoEntity, request.getId(),
                ...
                "tipoSezione", Sezione.SEZIONE_23_ATTIVITASENSIBILE);
            ...
            Attore attoreEntity = request.getAttore() != null
                ...
                : null;
            if (attoreEntity != null) attoreEntity.setExternalId(request.getId());
            mongoUtils.saveItem(attoreEntity, request.getId(),
