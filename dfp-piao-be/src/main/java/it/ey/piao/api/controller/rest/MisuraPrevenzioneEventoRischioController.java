...
public class MisuraPrevenzioneEventoRischioController {
                                           ...
                                           HttpServletRequest request)
    {
        ...
        misuraPrevenzioneEventoRischioService.deleteById(id, campiModificati, idPiao, testoSezione, updatedByNameSurname, updatedByRole, statoSezione);
                                                      ...
                                                      HttpServletRequest request)
    {
        ...
        String updatedByRole = request.getHeader("X-Updated-By-Role");
        String statoSezione = request.getHeader("X-Stato-Sezione");
        misuraPrevenzioneEventoRischioService.deleteByEventoRischio(idEventoRischio, campiModificati, idPiao, testoSezione, updatedByNameSurname, updatedByRole, statoSezione);
        return ResponseEntity.noContent().build();
    }
}
