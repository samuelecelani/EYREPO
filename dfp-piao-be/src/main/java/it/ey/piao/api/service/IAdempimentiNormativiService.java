...
public interface IAdempimentiNormativiService
{
    ...
    void deleteAdempimentoNormativo(Long id, String campiModificati, Long idPiao,String testoSezione,String updatedByNameSurname, String updatedByRole, String statoSezione);
}
