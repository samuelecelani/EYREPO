...
public interface PiaoMapper {
    ...
    @Mapping(target = "idAutoritaApprovatore", source = "autoritaApprovatore.id")
    @Mapping(target="statoPiao", source = "idStato", qualifiedByName = "statoPiaoFromIdStato")
     ...
     */
    @Mapping(target = "autoritaApprovatore.id", source = "idAutoritaApprovatore")
    @Mapping(target = "createdTs", ignore = true)
    @Mapping(target = "updatedTs", ignore = true)
    ...
    @Named("statoPiaoFromIdStato")
    default String statoPiaoFromIdStato(Long idStato) {
