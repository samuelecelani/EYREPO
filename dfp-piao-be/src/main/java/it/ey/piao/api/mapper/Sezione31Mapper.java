...
@Mapper(
    ...
    uses = {CommonMapper.class, SezioneBaseMapper.class, AmpiezzaOrganizzativaMapper.class, TabellaFunzionaleMapper.class}
)

public interface Sezione31Mapper
{
    /**
     * Mappa Sezione31 entity → DTO (include tutte le relazioni annidate)
     */
    ...
    /**
     * Mappa Sezione31 DTO → entity
     */


    @Mapping(target = "graficoMinerva", source = "graficoMinerva")
