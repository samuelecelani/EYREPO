...
public class CategoriaObiettiviController {
                                           ...
                                           HttpServletRequest request)
    {
        ...
        categoriaObiettiviService.deleteById(id, campiModificati, idPiao, testoSezione, updatedByNameSurname, updatedByRole, statoSezione);
        return ResponseEntity.noContent().build();
    }

    @GetMapping("/getAllCategoriaObiettivi")
    public ResponseEntity<List<CategoriaObiettiviTipDTO>> getAllCategoriaObiettivi(@RequestParam CodTipologiaCategoria codTipologiaFK) {
        List<CategoriaObiettiviTipDTO> result = categoriaObiettiviService.getAllCategoriaObiettiviTipPerCodTipologiaFK(codTipologiaFK);
        return ResponseEntity.ok(result);
    }
}
