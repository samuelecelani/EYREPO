...
@Mapper(
    ...
    uses = {CommonMapper.class, CategoriaObiettiviTipMapper.class}
)
public interface CategoriaObiettiviMapper {
    ...
    @Mapping(source = "idCategoriaObiettivi", target = "categoriaObiettiviTip.id")
    ...
    @Mapping(source = "categoriaObiettiviTip.id", target = "idCategoriaObiettivi")
