   ...
   public List<Piao> findByCodPAFK(String codPAF);
    ...
    @Query(value = """
        SELECT * FROM (
                        ...
                        LEFT JOIN anagrafica a ON a.idsezione1 = s1.id
    ...
    /**
     * Ricerca PIAO pubblicati (idStato=8) con filtri opzionali su codPAFK e tipologiaIstat (da Anagrafica via Sezione1).
     */
    @Query("""
    SELECT DISTINCT p
    FROM Piao p
