...
public class Sezione31ServiceImpl implements ISezione31Service
{
    ...
    public Sezione31DTO getOrCreateSezione(PiaoDTO piao)
    {
    ...
    public void saveOrUpdate(Sezione31DTO request)
    {
        ...
        try {
            ...
            storicoModificaHelper.salvaStoricoSePresente(request, savedEntity.getId(), request.getIdPiao(), Sezione.SEZIONE_31);
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    public Sezione31DTO richiediValidazione(Long id, String userNameSurname, String userRole, String fiscalCode, String testoSezione, String campiModificati)
    {
        ...
        try {
            ...
            Sezione31DTO dto = sezione31Mapper.toDto(saved, new CycleAvoidingMappingContext());
            ...
            storicoModificaHelper.salvaStoricoSePresente(dto, saved.getId(), saved.getPiao().getId(), Sezione.SEZIONE_31);
            return response;
        } catch (Exception e) {
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    public Sezione31DTO validaSezione(Long id, String userNameSurname, String userRole, String fiscalCode, String testoSezione, String campiModificati) {
        log.info("Validazione stato Sezione31 per id={}", id);
        CycleAvoidingMappingContext context = new CycleAvoidingMappingContext();
        ...
        try {
            ...
            log.error("Errore validazione Sezione31 {}", e.getMessage(), e);
            throw new RuntimeException("Errore validazione Sezione31", e);
        }
    }
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    public Sezione31DTO rifiutaValidazione(Long id, String osservazioni, String userNameSurname, String userRole, String fiscalCode, String testoSezione, String campiModificati) {
        log.info("Rifiuto validazione stato Sezione31 per id={}", id);
        CycleAvoidingMappingContext context = new CycleAvoidingMappingContext();
        ...
        try {
            ...
            log.error("Errore rifiuto validazione Sezione31 {}", e.getMessage(), e);
            throw new RuntimeException("Errore rifiuto validazione Sezione31", e);
        }
    }
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    public Sezione31DTO revocaValidazione(Long id, String osservazioni, String userNameSurname, String userRole, String fiscalCode, String testoSezione, String campiModificati) {
        log.info("Revoca validazione stato Sezione31 per id={}", id);
        CycleAvoidingMappingContext context = new CycleAvoidingMappingContext();
        ...
        try {
            ...
            throw new RuntimeException("Errore revoca validazione Sezione31", e);
        }
    }

    @Transactional(propagation = Propagation.REQUIRED)
    @Override
    public Sezione31DTO annullaValidazione(Long id, String userNameSurname, String userRole, String fiscalCode, String testoSezione, String campiModificati) {
        log.info("Annulla validazione stato Sezione31 per id={}", id);
        CycleAvoidingMappingContext context = new CycleAvoidingMappingContext();
        ...
        try {
            ...
            throw new RuntimeException("Errore annulla validazione Sezione31", e);
        }
    }

    @Override
    @Transactional(readOnly = true)
    public Sezione31DTO findByIdPiao(Long idPiao)
    {
        if (idPiao == null)
        {
            throw new IllegalArgumentException("Il PIAO non può essere nullo e deve avere un ID valido.");
        ...
        try {
            ...
            if (existing != null)
            {
                ...
                // Recupero tabelle funzionali associate alla sezione 31
                response.setTabelleFunzionali(tabellaFunzionaleMapper.toDtoList(
                    tabellaFunzionaleRepository.findByIdEntitaFKAndCodTipologiaFK(existing.getId(), Sezione.SEZIONE_31.name()),
                    context
                ));
    ...
    @Override
    public void saveMongoData(Sezione31DTO request) { }

    @Override
    public Sezione31DTO loadMongoData(Sezione31DTO sezione) { return null; }
}
