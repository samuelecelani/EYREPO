...
public interface IAdempimentoService
{
    ...
    void deleteAdempimento(Long id, String campiModificati, Long idPiao, String testoSezione, String updatedByNameSurname, String updatedByRole, String statoSezione);
}
