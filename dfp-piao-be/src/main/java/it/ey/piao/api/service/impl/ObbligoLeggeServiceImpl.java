...
public class ObbligoLeggeServiceImpl implements IObbligoLeggeService {
    ...
    public ObbligoLeggeDTO saveOrUpdate(ObbligoLeggeDTO obbligoLeggeDTO) {
        ...
        try {
            ...
            if (obbligoLeggeDTO.getCampiModificati() != null && !obbligoLeggeDTO.getCampiModificati().isBlank() && obbligoLeggeDTO.getIdPiao() != null ) {
                storicoModificaHelper.salvaStoricoSePresente(obbligoLeggeDTO, obbligoLeggeDTO.getIdSezione23(), obbligoLeggeDTO.getIdPiao(), Sezione.SEZIONE_23);
            }
            if (obbligoLeggeDTO.getStatoSezione() != null && !obbligoLeggeDTO.getStatoSezione().isBlank() && !StatoEnum.fromDescrizione(obbligoLeggeDTO.getStatoSezione()).name().equals(StoricoStatoSezioneUtils.getStato(storicoStatoSezioneRepository.findByIdEntitaAndCodTipologia(saved.getSezione23().getId(),Sezione.SEZIONE_23.name())))) {
                storicoStatoSezioneRepository.save(
                    StoricoStatoSezione.builder().statoSezione(
                            StatoSezione.builder()
                                .id(StatoEnum.fromDescrizione(obbligoLeggeDTO.getStatoSezione()).getId())
                                .testo(StatoEnum.fromDescrizione(obbligoLeggeDTO.getStatoSezione()).getDescrizione())
                                .build())
                        .idEntitaFK(saved.getSezione23().getId())
                        .codTipologiaFK(Sezione.SEZIONE_23.name())
                        .testo(StatoEnum.fromDescrizione(obbligoLeggeDTO.getStatoSezione()).getDescrizione())
                        .createdByNameSurname(obbligoLeggeDTO.getUpdatedByNameSurname())
                        .createdByRole(obbligoLeggeDTO.getUpdatedByRole())
                        .build());
            }
    ...
    public List<ObbligoLeggeDTO> getAllBySezione23(Long idSezione23) {
        ...
        try {
            ...
            List<ObbligoLegge> entities =
                obbligoLeggeRepository.getObiettivoPrevenzioneBySezione23(sezione23.getId());
    ...
    public void deleteById(Long id, String campiModificati, Long idPiao, String testoSezione, String updatedByNameSurname, String updatedByRole, String statoSezione) {
        ...
        try {
            ...
            // SOFT DELETE sulla relazione
            datiPubblicatiRepository.softDeleteByObbligoLeggeId(id,deactivationTime);

            // eliminiamo la corrispondenza trovata
            obbligoLeggeRepository.softDeleteById(entity.getId(), LocalDateTime.now());
