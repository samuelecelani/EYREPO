...
public class Indicatore extends CampiTecnici {
    ...
    @OneToMany(mappedBy = "indicatore", cascade = {CascadeType.PERSIST, CascadeType.MERGE}, orphanRemoval = false)
    ...
    @Filter(name = "activeFilter", condition = "X_ACTIVE = true")
    @OneToMany(mappedBy = "indicatore", cascade = {CascadeType.PERSIST, CascadeType.MERGE})
