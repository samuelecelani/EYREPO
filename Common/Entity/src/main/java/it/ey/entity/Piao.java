...
public class Piao extends CampiTecnici {
    ...
    @Column(name = "isCompilatoNormativa")
    private Boolean isCompilatoNormativa;

    @Column(name = "denominazionePA")
...
//    private Sezione23 sezione23;
    ...
    @JoinColumn(name = "idAutoritaApprovatore")
    private AutoritaApprovatore autoritaApprovatore;

    @Column(name = "EstremiAttoApprovazione")
    private String estremiAttoApprovazione;

    @Column(name = "TriennioRiferimento")
    private String triennioRiferimento;

    @Column(name = "ChangedTipologia")
    private Boolean changedTipologia;
