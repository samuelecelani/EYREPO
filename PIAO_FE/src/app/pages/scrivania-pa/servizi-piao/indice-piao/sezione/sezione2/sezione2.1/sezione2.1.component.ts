...
export class Sezione21Component extends BaseComponent implements OnInit, OnDestroy, ISezioneBase {
  ...
  createForm(): void {
    const sezione21 = this.sezione21Data || this.piaoDTO?.sezione21 || new Sezione21DTO();
    ...
    this.form = this.fb.group({
      ...
      ovp: createFormArrayOVPFromPiaoSession(this.fb, sezione21.ovp || [], INPUT_REGEX, {
        idSezione1: this.piaoDTO.sezione1?.id || -1,
          ...
          risorseArray.push(
            this.fb.group({
              ...
              fonteFinanziamento: [
                ...
                [Validators.maxLength(50), Validators.pattern(ONLY_NUMBERS_REGEX)],
              ],
            })
          );
        });
  ...
  validate(): Observable<any> {
    const sezione21Id = this.sezione21Data?.id || this.piaoDTO?.sezione21?.id || -1;
