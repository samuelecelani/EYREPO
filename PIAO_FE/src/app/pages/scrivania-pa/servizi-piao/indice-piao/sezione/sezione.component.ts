...
import { areAllValuesNull, collectNullPaths } from '../../../../../shared/utils/utils';
...
export class SezioneComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  postSaveSection(statoSezione: string, forceRefresh: boolean = false) {
  ...
  handleSaveToDraftSection(stepper: boolean = false, statoSezione: string = ''): void {
    const activeSezione = this.getActiveSezione();
    ...
    save$.subscribe({
      next: () => {
        ...
        if (stepper) {
          ...
          this.handleNextPreviousStep(this.isNextSection);
        }
      },
    });
  }
        ...
        if (this.sezione1Component) {
          ...
          return this.sezione1Service.save(sezione1ForSave).pipe(
            tap((value: any) => {
              ...
              this.sezione1Component!.sezione1Data = value;
      ...
      case '2.1': {
        if (this.sezione21Component) {
          ...
          return this.sezione21Service.save(sezione21ForSave).pipe(
            tap((value: any) => {
              this.piaoDTO.sezione21 = value;
              this.sezione21Component!.sezione21Data = value;
      ...
      case '2.2': {
        if (this.sezione22Component) {
          ...
          return this.sezione22Service.save(sezione22ForSave).pipe(
            tap((value: any) => {
              this.piaoDTO.sezione22 = value;
              this.sezione22Component!.sezione22Data = value;
      ...
      case '2.3': {
        if (this.sezione23Component) {
          ...
          return this.sezione23Service.save(sezione23ForSave).pipe(
            tap((value: any) => {
              this.piaoDTO.sezione23 = value;
              this.sezione23Component!.sezione23Data = value;
  ...
  handleNextPreviousStep(isNext: boolean) {
    ...
    if (!formIsNull) {
      ...
      const hasFormChanged =
        JSON.stringify(currentFormValue) !== JSON.stringify(this.sectionFormValue);

      console.log('Il form è cambiato?', hasFormChanged);

      if (hasFormChanged || (!this.validationOrSaveDraft && hasFormChanged)) {
  ...
  private checkPatternErrorsRecursively(control: any): boolean {
    if (control instanceof FormGroup || control instanceof FormArray) {
      for (const key in control.controls) {
        ...
        if (this.checkPatternErrorsRecursively(childControl)) {
          return true;
        }
      }
    }
