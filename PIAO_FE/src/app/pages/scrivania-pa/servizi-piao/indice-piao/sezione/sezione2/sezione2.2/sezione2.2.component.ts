...
export class Sezione22Component extends BaseComponent implements OnInit, OnDestroy, ISezioneBase {
  ...
  createForm(): void {
    const sezione22 = this.sezione22Data || this.piaoDTO?.sezione22 || new Sezione22DTO();
    ...
    this.form = this.fb.group({
      ...
      codTipologia: this.fb.control<string>(CodTipologiaSezioneEnum.SEZ2_1),
  ...
  validate(): Observable<any> {
    const sezione22Id = this.sezione22Data?.id || this.piaoDTO?.sezione22?.id || -1;
