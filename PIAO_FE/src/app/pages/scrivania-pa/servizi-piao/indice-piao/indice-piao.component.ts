...
import { GET_ALL_AVVISI } from '../../../../shared/utils/funzionalita';
      ...
      this.getVisibility(GET_ALL_AVVISI)
        ...
        .subscribe({
          next: (res: any) => {
            ...
            this.labelValueConfig[2].value = res.description;
            this.labelValueConfig[3].value = this.piaoDTO.statoPiao;

            this.disablebuttonValidation = !this.isVisible ? true : false;
          },
        });
    }
  }

  handleValidationPiao() {
