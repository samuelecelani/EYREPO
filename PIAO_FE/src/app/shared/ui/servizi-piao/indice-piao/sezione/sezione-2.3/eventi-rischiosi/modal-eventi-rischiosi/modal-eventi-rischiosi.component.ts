...
export class ModalEventiRischiosiComponent extends ModalBodyComponent implements OnInit {
  ...
  livelloRischioDropdown: LabelValue[] = [
    { label: 'SEZIONE_23.EVENTI_RISCHIOSI.MODAL.LIVELLO_BASSO', value: 1 },
    { label: 'SEZIONE_23.EVENTI_RISCHIOSI.MODAL.LIVELLO_MEDIO', value: 2 },
    { label: 'SEZIONE_23.EVENTI_RISCHIOSI.MODAL.LIVELLO_ALTO', value: 3 },
  ];
