        ...
        if (
          ...
          switch (this.sezione) {
            case SectionEnum.SEZIONE_1:
              if (this.piaoDTO?.sezione1?.allegati && this.piaoDTO.sezione1.allegati[0]) {
                this.piaoDTO.sezione1.allegati[0].descrizione = undefined;
              }
              break;
            case SectionEnum.SEZIONE_2_1:
              if (this.piaoDTO?.sezione21?.allegati && this.piaoDTO.sezione21.allegati[0]) {
                this.piaoDTO.sezione21.allegati[0].descrizione = undefined;
              }
              break;
            case SectionEnum.SEZIONE_2_2:
              if (this.piaoDTO?.sezione22?.allegati && this.piaoDTO.sezione22.allegati[0]) {
                this.piaoDTO.sezione22.allegati[0].descrizione = undefined;
              }
              break;
            case SectionEnum.SEZIONE_2_3:
              if (this.piaoDTO?.sezione23?.allegati && this.piaoDTO.sezione23.allegati[0]) {
                this.piaoDTO.sezione23.allegati[0].descrizione = undefined;
              }
              break;
