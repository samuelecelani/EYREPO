...
import { CampiModificatiService } from './shared/services/campi-modificati-service';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideAppInitializer(() => {
      const service = inject(CampiModificatiService);
      return service.loadConfig().catch((err) => {
        console.error('Errore caricamento config campi modificati:', err);
      });
    }),
