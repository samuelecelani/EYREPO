...
import { RoleRoutingService } from '../../shared/services/role-routing.service';
...
export class NotificheComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.roleRoutingService
      .getHomeRoute$()
      .pipe(take(1))
      .pipe(takeUntilDestroyed(this.destroyRef)).subscribe((route) => (this.homeRoute = route));
