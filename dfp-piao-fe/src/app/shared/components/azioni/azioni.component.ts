...
export class AzioniComponent implements OnInit, OnDestroy {
  ...
  trackByAction(_index: number, action: IVerticalEllipsisActions): string {
    return action?.label ?? String(_index);
  }
