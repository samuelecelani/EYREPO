...
export class BaseComponent implements OnDestroy {
  ...
  getPaRiferimento(): PARiferimentoDTO | null {
    ...
    this.accountService
      ...
      .subscribe({
        error: (e) => console.error('getPaRiferimento error:', e),
      });
  ...
  getUser(): UtenteDTO | null {
    ...
    this.accountService
      ...
      .subscribe({
        error: (e) => console.error('getUser error:', e),
      });
  ...
  protected loadFunzionalita(): void {
    ...
    this.accountService
      ...
      .subscribe({
        error: (e) => console.error('loadFunzionalita error:', e),
      });
  }
 ...
 */
  ...
  isSezioneNonAssociata(activeSectionId: string): boolean {
    ...
    // Il REFERENTE ha sempre accesso a tutte le sezioni: non viene mai bloccato.
    if (ctx.ruoloUtente === CodRuoloEnum.REFERENTE) {
      return true;
    }
