...
export class Sezione332Service {
  ...
  reloadSezione332AndUpdateSession(): Observable<Sezione332DTO | undefined> {
    ...
    console.log('[Sezione332Service] reloadSezione332AndUpdateSession called', piaoDTO?.id);
    ...
    console.log('[Sezione332Service] piaoDTO.id not found, returning undefined');
    return of(undefined);
  }
