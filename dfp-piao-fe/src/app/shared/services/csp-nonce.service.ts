...
export class CspNonceService {
   ...
   * e applicando il nonce agli stili inline esistenti.
   *
   * NOTA: il MutationObserver è disattivato; gli stili aggiunti dinamicamente
   * dopo l'init NON verranno processati.
   */
  init(): void {
   ...
   *
   * DISATTIVATO (usato solo dal MutationObserver).
   */
  ...
  /**
   * Ferma il MutationObserver (disattivato)
   */
  destroy(): void {
    // if (this.observer) {
