...
export class AmpiezzaOrganizzativaComponent extends BaseComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log('ampiezza organizzativa', this.ampiezzaOrganizzativaArray);
    this.ampiezzaIndex = this.ampiezzaOrganizzativaArray.length;
    console.log(
      'ampiezza organizzativa',
      this.ampiezzaOrganizzativaArray.length,
      this.ampiezzaOrganizzativaArray.length === 0
    );
  }
  ...
  handleAddAmpiezzaOrganizzativa(): void {
    ...
    this.ampiezzaOrganizzativaService.save(formValue).subscribe({
      next: () => {
