...
public class OvpServiceImpl implements IOVPService {
    ...
    @Override
    public Mono<GenericResponseDTO<List<ItemMatriceDTO>>> getOvpMatriceByIdSezione21(Long idSezione21,Long idSezione1) {
        log.info("Recupero matrice OVP completa per sezione21={}", idSezione21);
        HttpHeaders headers = new HttpHeaders();
        headers.set("Accept", "application/json");

        return webClientService.get("/ovp/matrice-data/" + idSezione21 + "/" + idSezione1, webServiceType, headers,
