...
public class Sezione22Controller {
    ...
    @PostMapping("/save")
    public Mono<ResponseEntity<GenericResponseDTO<Sezione22DTO>>> save(@RequestBody Sezione22DTO request) {
    ...
    @PostMapping("/piao")
    public Mono<ResponseEntity<GenericResponseDTO<Sezione22DTO>>> getOrCreatePIAO(@RequestBody PiaoDTO request) {
        return sezione22Service.getOrCreate(request)
            .map(ResponseEntity::ok);
    }
}
