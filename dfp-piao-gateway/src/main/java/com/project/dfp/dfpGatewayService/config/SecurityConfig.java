    ...
    SecurityWebFilterChain springWebFilterChain(ServerHttpSecurity http) {
        ...
        if (authEnabled) {
            http.authorizeExchange((authorize) -> authorize
            		...
            		.pathMatchers("/api/piao/bff/config/**").permitAll()
                    .pathMatchers("/area-riservata/config/**").permitAll()
                    .pathMatchers("/area-riservata/api/piao/bff/config/**").permitAll()
            		.pathMatchers("/api/piao/bff/external/**").permitAll()
                    .pathMatchers("/area-riservata/external/**").permitAll()
                    .pathMatchers("/area-riservata/api/piao/bff/external/**").permitAll()
