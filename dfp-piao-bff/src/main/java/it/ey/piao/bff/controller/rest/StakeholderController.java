...
public class StakeholderController {
    ...
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<GenericResponseDTO<Void>>> deleteById(@PathVariable Long id,
        ...
        return stakeholderService.deleteById(id, campiModificati, idPiao, testoSezione,forceDelete)
            .map(ResponseEntity::ok);
    }
}
