...
public class MisuraPrevenzioneEventoRischioController {
    ...
    public Mono<ResponseEntity<Void>> deleteById(@PathVariable Long id,
        ...
        return misuraPrevenzioneEventoRischioService.deleteById(id, campiModificati, idPiao, testoSezione)
    ...
    public Mono<ResponseEntity<Void>> deleteByEventoRischio(@PathVariable Long idEventoRischio,
                                                            ...
                                                            @RequestParam(required = false) String testoSezione,
                                                            @RequestParam(required = false) String statoSezione) {
        return misuraPrevenzioneEventoRischioService.deleteByEventoRischio(idEventoRischio, campiModificati, idPiao, testoSezione)
            .then(Mono.just(ResponseEntity.noContent().<Void>build()));
    }
