...
public class S3Service {
     ...
     * Legge dal bucket staging (default) o dal definitivo in base al flag antivirus.
     */
    public Mono<String> generatePresignedUrl(String fileKey) {
        String bucket = antivirusEnabled ? S3bucketDefinitive : S3bucketName;
        return generatePresignedUrlFromBucket(fileKey, bucket);
    }
