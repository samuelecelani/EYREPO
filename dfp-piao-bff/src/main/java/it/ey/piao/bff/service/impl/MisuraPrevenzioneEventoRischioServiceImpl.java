...
public class MisuraPrevenzioneEventoRischioServiceImpl implements IMisuraPrevenzioneEventoRischioService {
    ...
    public Mono<Void> deleteById(Long id, String campiModificati, Long idPiao, String testoSezione) {
        ...
        StringBuilder url = new StringBuilder("/misura-prevenzione-evento-rischio/" + id + "?");
    ...
    @Override
    public Mono<Void> deleteByEventoRischio(Long idEventoRischio, String campiModificati, Long idPiao, String testoSezione) {
        log.info("Richiesta cancellazione MisuraPrevenzioneEventoRischio per EventoRischio id={}", idEventoRischio);
        HttpHeaders headers = new HttpHeaders();
        headers.set("Accept", "application/json");

        StringBuilder url = new StringBuilder("/misura-prevenzione-evento-rischio/eventoRischio/" + idEventoRischio + "?");
        if (campiModificati != null && !campiModificati.isBlank()) url.append("campiModificati=").append(campiModificati).append("&");
        if (idPiao != null) url.append("idPiao=").append(idPiao).append("&");
        if (testoSezione != null && !testoSezione.isBlank()) url.append("testoSezione=").append(testoSezione);
