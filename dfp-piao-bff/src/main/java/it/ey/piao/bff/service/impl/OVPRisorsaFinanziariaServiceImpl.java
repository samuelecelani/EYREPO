...
public class OVPRisorsaFinanziariaServiceImpl implements IOVPRisorsaFinanziariaService {
    ...
    public OVPRisorsaFinanziariaServiceImpl(WebClientService webClientService) {
    ...
    public Mono<GenericResponseDTO<Void>> deleteById(Long id, String campiModificati, Long idPiao, String testoSezione) {
        ...
        log.info("Richiesta cancellazione OVPRisorsaFinanziaria con id={}", id);

        HttpHeaders headers = new HttpHeaders();
        headers.set("Accept", "application/json");

        StringBuilder url = new StringBuilder("/ovp-risorse-finanziarie/" + id + "?");
        ...
        return webClientService
            ...
            .map(apiResponse -> {
                ...
                if (apiResponse != null && apiResponse.getError() != null) {
                    ...
                    MetadatoDTO<Object> metadato = MetadatoDTO.<Object>builder()
                        .value(OVPRisorsaFinanziariaDTO.class.getSimpleName())
                        .idFK(id)
                        .idPiao(idPiao)
                        .build();
            ...
            .onErrorResume(e -> {
                ...
                log.error("Errore cancellazione OVPRisorsaFinanziaria id={}: {}", id, e.getMessage(), e);
                ...
                if (e instanceof WebClientResponseException webEx) {
                    try {
                        ...
                        log.warn("Errore parsing body risposta OVPRisorsaFinanziaria", exParse);
