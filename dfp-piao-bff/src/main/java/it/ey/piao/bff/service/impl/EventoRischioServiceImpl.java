...
public class EventoRischioServiceImpl implements IEventoRischioService {
    ...
    public Mono<Void> deleteById(Long id, String campiModificati, Long idPiao, String testoSezione) {
        ...
        StringBuilder url = new StringBuilder("/evento-rischio/" + id + "?");
    ...
    @Override
    public Mono<Void> deleteByAttivitaSensibile(Long idAttivitaSensibile, String campiModificati, Long idPiao, String testoSezione) {
        log.info("Richiesta cancellazione EventiRischio per AttivitaSensibile con id={}", idAttivitaSensibile);

        HttpHeaders headers = new HttpHeaders();
        headers.set("Accept", "application/json");

        StringBuilder url = new StringBuilder("/evento-rischio/attivita-sensibile/" + idAttivitaSensibile + "?");
        if (campiModificati != null && !campiModificati.isBlank()) url.append("campiModificati=").append(campiModificati).append("&");
        if (idPiao != null) url.append("idPiao=").append(idPiao).append("&");
        if (testoSezione != null && !testoSezione.isBlank()) url.append("testoSezione=").append(testoSezione);
