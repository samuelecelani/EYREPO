...
public class AdempimentoServiceImpl implements IAdempimentoService
{
    ...
    @Override
    public Mono<GenericResponseDTO<Void>> deleteAdempimento(Long id, String campiModificati, Long idPiao, String testoSezione)
    {
        ...
        StringBuilder url = new StringBuilder("/adempimento/" + id + "?");
