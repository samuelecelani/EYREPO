...
public class AdempimentiNormativiServiceImpl implements IAdempimentiNormativiService
{
    ...
    @Override
    public Mono<GenericResponseDTO<Void>> deleteAdempimentoNormativo(Long id, String campiModificati, Long idPiao, String testoSezione)
    {
        ...
        StringBuilder url = new StringBuilder("/adempimenti-normativi/" + id + "?");
