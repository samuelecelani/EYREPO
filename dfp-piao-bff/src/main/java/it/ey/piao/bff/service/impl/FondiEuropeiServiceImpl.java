...
public class FondiEuropeiServiceImpl implements IFondiEuropeiService {
    ...
    public FondiEuropeiServiceImpl(WebClientService webClientService) {
    ...
    public Mono<GenericResponseDTO<Void>> deleteById(Long id, String campiModificati, Long idPiao, String testoSezione) {
        ...
        log.info("Richiesta cancellazione FondiEuropei con id={}", id);

        HttpHeaders headers = new HttpHeaders();
        headers.set("Accept", "application/json");

        StringBuilder url = new StringBuilder("/fondi-europei/" + id + "?");
        ...
        return webClientService
            ...
            .map(apiResponse -> {
                ...
                if (apiResponse != null && apiResponse.getError() != null) {
                    ...
                    MetadatoDTO<Object> metadato = MetadatoDTO.<Object>builder()
                        .value(FondiEuropeiDTO.class.getSimpleName())
                        .idFK(id)
                        .idPiao(idPiao)
                        .build();
            ...
            .onErrorResume(e -> {
                ...
                log.error("Errore cancellazione FondiEuropei id={}: {}", id, e.getMessage(), e);
                ...
                if (e instanceof WebClientResponseException webEx) {
                    try {
                        ...
                        log.warn("Errore parsing body risposta FondiEuropei", exParse);
