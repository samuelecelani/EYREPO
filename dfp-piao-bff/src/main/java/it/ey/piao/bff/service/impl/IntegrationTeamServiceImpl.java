...
import it.ey.dto.IntegrationTeamDTO;
...
public class IntegrationTeamServiceImpl implements IIntegrationTeamService {
    ...
    public IntegrationTeamServiceImpl(WebClientService webClientService) {
    ...
    public Mono<GenericResponseDTO<Void>> deleteById(Long id, String campiModificati, Long idPiao, String testoSezione) {
        ...
        log.info("Richiesta cancellazione IntegrationTeam con id={}", id);

        HttpHeaders headers = new HttpHeaders();
        headers.set("Accept", "application/json");

        StringBuilder url = new StringBuilder("/integration-team/" + id + "?");
        ...
        return webClientService
            ...
            .map(apiResponse -> {
                ...
                if (apiResponse != null && apiResponse.getError() != null) {
                    ...
                    MetadatoDTO<Object> metadato = MetadatoDTO.<Object>builder()
                        .value(IntegrationTeamDTO.class.getSimpleName())
                        .idFK(id)
                        .idPiao(idPiao)
                        .build();
            ...
            .onErrorResume(e -> {
                ...
                log.error("Errore cancellazione IntegrationTeam id={}: {}", id, e.getMessage(), e);
                ...
                if (e instanceof WebClientResponseException webEx) {
                    try {
                        ...
                        log.warn("Errore parsing body risposta IntegrationTeam", exParse);
