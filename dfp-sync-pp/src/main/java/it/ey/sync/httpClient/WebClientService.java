...
/**
 * Classe atomica e centralizzata per gestire le chiamate REST
 * attraverso l'utilizzo di WebClient.
 * L'URL base viene risolto dall'enum {@link WebServiceType}.
 */
@Service
