...
public class AttivitaSensibileController {
    ...
    @PostMapping("/save")
    public ResponseEntity<AttivitaSensibileDTO> saveOrUpdate(@RequestBody AttivitaSensibileDTO request) {
        AttivitaSensibileDTO response = attivitaSensibileService.saveOrUpdate(request);
