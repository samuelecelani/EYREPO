...
public class MisuraPrevenzioneController {
    ...
    @PostMapping("/save")
    public ResponseEntity<MisuraPrevenzioneDTO> saveOrUpdate(@RequestBody MisuraPrevenzioneDTO request) {
        MisuraPrevenzioneDTO response = misuraPrevenzioneService.saveOrUpdate(request);
