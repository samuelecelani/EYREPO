...
public class PiaoServiceImpl implements IPiaoService {
    ...
    public PiaoDTO getOrCreatePiao(PiaoDTO piao) {
        try {
            ...
            if (existing != null){
                ...
                PiaoDTO response = piaoMapper.toDto(existing);
                return populateSezioni(response);
                }
                    ...
                    if(nextYear ){
                       Piao piaoNextYear =  piaoRepository.findTopByCodPAFKAndCreatedTsBetweenOrderByVersioneDesc(
                        ...
                        if (piaoNextYear == null) {
                            ...
                            PiaoDTO response = piaoMapper.toDto(piaoNextYear);
                            return populateSezioni(response);
                        }
                        else{
    ...
    public List<PiaoDTO> getAllPiaoByCodPAFK(String codPAF) {
        return  piaoRepository.findByCodPAFKOrderByCreatedTsDesc(codPAF)
            .stream()
            .map(res ->{
                PiaoDTO response = piaoMapper.toDto(res);
    ...
    private PiaoDTO createPiao(PiaoDTO piao, boolean nextYear) {
        ...
        try {
            ...
            newPiao.setIdStato(StatoEnum.DA_COMPILARE.getId());
             response = piaoMapper.toDto(piaoRepository.save(newPiao));
     ...
     */
    private PiaoDTO populateSezioni(PiaoDTO piaoDTO) {
        piaoDTO.setSezione1(sezione1Service.getOrCreateSezione1(piaoDTO));
        piaoDTO.setSezione21(sezione21Service.getOrCreateSezione21(piaoDTO));
        piaoDTO.setSezione22(sezione22Service.getOrCreateSezione22(piaoDTO));
        piaoDTO.setSezione23(sezione23Service.getOrCreateSezione23(piaoDTO));
        piaoDTO.setSezione4(sezione4Service.getOrCreateSezione4(piaoDTO));
        return piaoDTO;
    }
}
