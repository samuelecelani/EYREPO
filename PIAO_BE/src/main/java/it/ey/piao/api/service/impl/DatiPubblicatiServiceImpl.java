...
public class DatiPubblicatiServiceImpl implements IDatiPubblicatiService {
    ...
    public DatiPubblicatiDTO saveOrUpdate(DatiPubblicatiDTO dto) {
        ...
        try {
            ...
            // DTO → Entity JPA
            DatiPubblicati entity = datiPubblicatiMapper.toEntity(dto);
            ...
            // Entity → DTO risposta
            response = datiPubblicatiMapper.toDTO(savedEntity);
            ...
            if (dto.getUlterioriInfo() != null) {
                ...
                UlterioriInfo savedInfo = mongoUtils.saveItem(
                    ...
                    UlterioriInfo.class,
                    en -> en.setTipoSezione(Sezione.SEZIONE_23_DATIPUBBLICATI) // usa il tuo enum corretto
                );
            ...
            eventPublisher.publishEvent(
                new TransactionFailureEvent<>(
                    datiPubblicatiMapper.toEntity(dto),
                    e
                )
            );
            ...
            response = entities.stream()
                .map(entity -> {
                    ...
                    DatiPubblicatiDTO dto =
                        datiPubblicatiMapper.toDTO(entity);
