...
public class MonitoraggioPrevenzioneServiceImpl implements IMonitoraggioPrevenzioneService
{
    ...
    public MonitoraggioPrevenzioneDTO saveOrUpdate(MonitoraggioPrevenzioneDTO dto)
    {
        ...
        try {
            ...
            if (dto.getMisuraPrevenzioneEventoRischio() != null && dto.getMisuraPrevenzioneEventoRischio().getId() != null) {
                entity.setMisuraPrevenzioneEventoRischio(misuraPrevenzioneEventoRischioRepository.getReferenceById(dto.getMisuraPrevenzioneEventoRischio().getId()));
            }
