...
public class OVPController {
    ...
    @GetMapping("/matrice-data/{idSezione}/{idSezione1}")
    public ResponseEntity<OVPMatriceDataDTO> getMatriceData(@PathVariable Long idSezione, @PathVariable Long idSezione1) {
        return ResponseEntity.ok(ovpService.findOVPMatriceData(idSezione, idSezione1));
    }
