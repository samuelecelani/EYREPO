...
public interface AttivitaSensibileMapper {
    ...
    @Mapping(target = "eventoRischio", ignore = true) // Gestito separatamente nel service
    AttivitaSensibileDTO toDto(AttivitaSensibile entity);
    ...
    AttivitaSensibile toEntity(AttivitaSensibileDTO dto);

    /**
     * Mappa lista AttivitaSensibile entity → DTO
     */
    List<AttivitaSensibileDTO> toDtoList(List<AttivitaSensibile> entities);
