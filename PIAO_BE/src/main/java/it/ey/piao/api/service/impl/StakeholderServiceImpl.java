...
public class StakeholderServiceImpl implements IStakeholderService {
    ...
    public StakeholderServiceImpl(IStakeHolderRepository stakeholderRepository, StakeHolderMapper stakeHolderMapper) {
    ...
    public List<StakeHolderDTO> findByidPiao(Long idPiao) {
        ...
        try {
            ...
            return stakeHolderMapper.toDtoList(stakeholderRepository.findByPiao(Piao.builder().id(idPiao).build()),new CycleAvoidingMappingContext());
